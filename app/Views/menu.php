...
<li class="nav-item">
        <a class="nav-link" href="<?= site_url("welcome"); ?>"><i class="fa fa-home"></i> Home</a>
</li>
<li class="nav-item">
        <a class="nav-link" href="<?= site_url("products"); ?>"><i class="fa fa-product-hunt"></i> Products</a>
</li>
<li class="nav-item">
...
<li class="nav-item">
        <a class="nav-link" href="#"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Add to cart</a>
</li>
<div class="d-flex ms-auto order-5"> 
<li class="nav-item">
        <a class="nav-link dropdown-toggle text-blue " data-toggle="dropdown" href="#">Account<i class="fa fa-user"></i></a>
        <div class="dropdown-menu">
<a href="#" class="dropdown-item">Register</a><a href="<?= site_url("login"); ?>" class="dropdown-item">Login</a> <a href="#" class="dropdown-item">Log out</a>
